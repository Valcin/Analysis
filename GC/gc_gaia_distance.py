...
#--------------
	...
	mag_vy, mag_iy, Color_isoy, eep_firsty = iso_mag(np.log10(13.379e9), -1.455, 19406, 0.64, 0)
	mag_vz, mag_iz, Color_isoz, eep_firstz = iso_mag(np.log10(13.388e9), -1.412, 19436, 0.598, 0)
