...
class DartmouthModelGrid(ModelGrid):
    ...
    phot_systems = ('SDSSugriz','UBVRIJHKsKp','WISE','LSST','HST_ACSWF', 'UKIDSS','HST_WFC3')
    phot_bands = dict(SDSSugriz=['sdss_z', 'sdss_i', 'sdss_r', 'sdss_u', 'sdss_g'],
                  UBVRIJHKsKp=['B', 'I', 'H', 'J', 'Ks', 'R', 'U', 'V', 'D51', 'Kp'],
                  WISE=['W4', 'W3', 'W2', 'W1'],
                  HST_ACSWF=['F606W', 'F814W'],
                  LSST=['LSST_r', 'LSST_u', 'LSST_y', 'LSST_z', 'LSST_g', 'LSST_i'],
                  UKIDSS=['Y', 'H', 'K', 'J', 'Z'],
    ...
    #~ default_bands = ('B','V','g','r','i','z',
                     #~ 'J','H','K','I',
                     #~ 'W1','W2','W3','Kepler','F606W', 'F814W')
    default_bands = ('F606W', 'F814W')
    ...
    def get_filenames(self, phot, afe='afem2', y=''):
        afe = self.kwargs['afe']
        y = self.kwargs['y']
