...
class MISTModelGrid(ModelGrid):
    ...
    phot_systems = ('CFHT', 'DECam', 'GALEX', 'JWST', 'LSST', 'PanSTARRS',
                    'SDSS', 'HST_ACSWF','HST_WFPC2', 'SPITZER', 'SkyMapper', 'UBVRIplus', 'UKIDSS', 'WISE')
    ...
    phot_bands = dict(UBVRIplus=['Bessell_U', 'Bessell_B', 'Bessell_V',
                      ...
                      HST_WFPC2=['WFPC2_F606W', 'WFPC2_F814W'],
    ...
    #~ default_bands = ('G','B','V','J','H','K','W1','W2','W3','g','r')
    ...
    def get_band(cls, b, **kwargs):
        ...
        if b in ['u','g','r','i','z']:
            ...
            phot = 'HST_WFPC2'
            band = 'WFPC2_{}W'.format(b)
        elif b in  ['F606W', 'F814W']:
            phot = 'HST_ACSWF'
            band = 'ACS_WFC_{}'.format(b)
        elif b in  ['J','H','Ks']:
            phot = 'UBVRIplus'
