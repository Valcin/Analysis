...
########################################################################
	...
	Class = np.loadtxt('/home/dvalcin/codes/Paco/data2/0.15eV/expected_Pk_z='+str(z)+'.txt')
	Class_trans = np.loadtxt('/home/dvalcin/codes/Paco/data2/0.15eV/test_'+str(z)+'_tk.dat')
	kclass = Class[:,0]
	Pclass = Class[:,1]
	...
	#~ cname = '/home/dvalcin/codes/Paco/data2/0.15eV/Plin_z='+str(z)+'.txt'
...
#~ for i in dispo:
		myfile1 = '/home/dvalcin/codes/Paco/data2/0.15eV/NCV'+str(i)+'/density_field_c_z='+str(z)+'00.hdf5'
